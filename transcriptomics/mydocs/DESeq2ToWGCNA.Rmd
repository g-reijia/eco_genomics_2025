...
Run WGCNA and data and do basic DESeq2 data filtering:
...
Important phenotypic/trait data:
```{r}
...
#make sure you have the variance stabilized dds object 
...
- What power are we choosing and why?
- 
```{r}
# Choose a set of soft-thresholding powers
...
sft <- pickSoftThreshold(norm.counts, 
                         powerVector = power,
                         networkType = "signed", #includes positive and negative logfoldchange.
                         verbose = 5)
...
# memory estimate w.r.t blocksize; set maxBlockSize to greater than number of genes to run network construction all at once
...
Plot the dendrograms of modules:
```{r}
