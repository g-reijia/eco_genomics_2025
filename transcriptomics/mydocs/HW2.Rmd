...
# Dark colors are more significant and ranked in order. The number of significant genes in those categories is scaled by size of the dots. We can't see all of the GO terms but they are listed along the side.
```
