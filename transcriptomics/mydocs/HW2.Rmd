...
Looking at the relationship between above metrics:
```{r}
...
- This plot shows the individual genes that are along the tail distribution. In the area above the threshold/cutoff line, there are 400-500 genes present.
```{r}
