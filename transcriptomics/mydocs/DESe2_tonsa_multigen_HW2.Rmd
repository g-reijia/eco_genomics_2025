---
title: "DESeq2_tonsa_multigen_HW2"
author: "Rei Jia"
date: "2025-11-05"
...
```{r}
# Step included in this pipeline because DESeq2 package doesn't like decimal points, and Salmon outputs data with decimals:
...
- Despite lots of zeros across the 119,000 transcripts, there is an average of ~2500 reads mapping per transcript.
```{r}
...
```{r include=FALSE}
# Here, we filter out genes with too few reads by removing all genes with counts < 15 in more than 75% of 24 samples, so 18). 
