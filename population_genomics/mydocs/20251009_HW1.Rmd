...
allRS_COV <- as.matrix(read.table("allRS_poly_K3.cov"))
...
```{r}
#outlier_contigs_PC1 <- rename(outliers_PC1, Chr=chromo)

#outlier_contigs_PC2 <- rename(outliers_PC2, Chr=chromo)

```

4b. Generate VennDiagram:
```{r}
#outliers_venn = list(TajimaD = theta2$Chr, outliers_PC1 = outliers_PC1$Chr, PC2_outliers = outliers_PC2$Chr)

#View(outliers_venn)

#ggVennDiagram(outliers_venn,
                  color = "black", # Border color of sets
                  lwd = 1.5) + # Line width of set borders
