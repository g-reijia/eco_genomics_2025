...
Screeplot of the variance explained, barplot that shows variance explain with successfully high eigen values
```{r}
barplot(var, 
...
Bar plot below that will plot admixture coefficients:
```{r}
barplot(t(q)[,ord],
        #col=cols[1:K],
        col=c("black","red"),
