...
mkdir ~/projects/eco_genomics_2025/population_genomics/mydata/ANGSD_HW1

INPUT="/gpfs1/cl/ecogen/pbio6800/PopulationGenomics/bams"

OUT="/users/g/j/gjia/projects/eco_genomics_2025/population_genomics/mydata/ANGSD_HW1"
