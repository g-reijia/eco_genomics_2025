...
#SBATCH --output=/users/g/j/gjia/projects/eco_genomics_2025/population_genomics/mylogs/%x_%j.out
...
# This script will ues ANGSD to estimate Fst between my red spruce population and black spruce from outside the range

# Path to the `population_genomics` folder in your repo

REPO="/users/g/j/gjia/projects/eco_genomics_2025/population_genomics"

# Path to the Black Spruce (BS) input saf.idx data (Steve made this file for us using the ANGSD.sh script)
