#!/bin/bash   
# This script loops through a set of files defined by XXXX, using single-end reads
...
mkdir ${MYREPO}/GroupProjects/picea_rnaseq/fastpRun2_reports

# cd to the location (path) to the fastq data:

cd /gpfs1/cl/ecogen/pbio6800/GroupProjects/fastq_run2
...
NAME1=$(echo $READ1 | sed "s/_R2/_R2_cleanXX/g")
...
# call bbduk
$bbduk -i ${READ1} \
in=${READ1} out=${NAME1} ref=adapters ktrim=r k=23 mink=11 hdist=1 tpe tbo \
-- trimpolya=10 \
done