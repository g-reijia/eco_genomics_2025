...
combined_DEGsGOplot <-(cwCvsH_TopGOplot + hdCvsH_TopGOplot)/(cwCvsDH_TopGOplot + hdCvsDH_TopGOplot)/ (cwHvsDH_TopGOplot + hdHvsDH_TopGOplot)

ggsave("combined_DEGsGOplot.png", plot = combined_DEGsGOplot, width=15, height=17, units = "in", dpi = 300)
```
