...
# plot
plot(sampleTree, main="Sample clustering to detect outliers", sub="", xlab="",cex.lab=0.5, cex.axis=0.5, cex.main=2)
...
There are no obvious clusters observed... so I will make groups to test specific contrasts below:
```{r}

# start again from here!!!!!!!
metadata_spruce$source_climate <- metadata_spruce$source_climate
dds$treatment <- relevel(dds$treatment, ref = "Control")
dds$source_climate <- relevel(dds$source_climate, ref = "") #getting an error here, still.
